<?php
    ...
    {
    if($email!=null&&$mno!=null&&$psw!=null&&$psw1!=null)
   {
     $k=mysql_query("update registration set upass='$psw' where Mobile_NO='$mno' AND Email='$email';");
     if($k==true)
     {
        echo("<script language='javascript'>alert('Forgot Password succesfully.....')</script>");
     }
     else
       echo("<script language='javascript'>alert('INvalid Mobile Or Email.....')</script>");
    mysql_close($con);
   }
   else
     echo("<script language='javascript'>alert('Password are not same.....')</script>");
   }
?>
<html>
<head>
