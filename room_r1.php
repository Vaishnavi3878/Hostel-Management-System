...
<?php
   ...
   mysql_query("use project1");
    ...
    echo("<table width='50%' height='110%' align='center' border='1' bordercolor='white' style='border-collapse:collapse'>");
    echo("<tr bgcolor='white'><th style='color:brown;font-size:20'>Room No<th style='color:brown;font-size:20'>No of Bed<th style='color:brown;font-size:20'>No of allocated Students</tr>");
...
<br>
<div class="see">
See Available beds Form Addmission <a href="bed.php" style="text-decoration:none">&nbsp<i class="fa-solid fa-arrow-right"></i><a>
</div> <br><br>
</body>
</html>